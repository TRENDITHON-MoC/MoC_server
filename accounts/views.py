...
def login_api(social_type: str, social_id: str, email: str=None, phone: str=None): # 회원가입 및 로그인
...
class KakaoLoginView(APIView):
    ...
    def get(self, request): # Kakao 코드 요청
...
class KakaoCallbackView(APIView):
    ...
    def get(self, request): # kakao access_token 및 user_info 요청
